      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="mb-12 border-b border-black/10 pb-8">
          ...
          <p className="font-sans text-sm text-[#0A0A0A]/60">
            Effective Date: January 1, 2026 · TradePe Tech Pvt. Ltd., 61, Mittal Chambers, Nariman Point, Mumbai 400021
          </p>
        </div>
        ...
        <div className="space-y-10 font-sans text-sm sm:text-base text-[#0A0A0A]/80 leading-relaxed">
          <section className="space-y-3">
            ...
            <p>
              TradePe Tech Pvt. Ltd. collects institutional corporate information including Certificate of Incorporation, Goods &amp; Services Tax Identification Number (GSTIN), Importer Exporter Code (IEC), Legal Entity Identifier (LEI), director KYC, and transactional invoices necessary to fulfill statutory anti-money laundering and FEMA regulatory mandates.
            </p>
          </section>
